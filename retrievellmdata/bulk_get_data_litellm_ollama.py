...
# PARAMETERS
sql_db_name = '../records_output.db'  # Used to store the ids of prompts and responses
root_input_prompt_dir = Path('../prompts')  # Top level directory with sub-directories for each prompt
root_output_dir = Path('../outputs/ollama_20250506_temp0.0')
...
if __name__ == '__main__':
    ...
    # bulk_run_models_on_prompt(10,Path(r'C:\windows\path\to\llm testing\Zooniverse project\prompts'),models)
